...
export async function renderContract(input) {
  ...
  return {
    'types.ts': `// Generated by admin-kit. Regenerate from the contract.\n${types}`,
    'client.ts': `// Generated by admin-kit. Regenerate from the contract.\nimport type { operations } from './types';\nimport { request } from '../transport/request';\nimport definitions from './definitions.json';\n\n${clients}\n`,
    'definitions.json': `${JSON.stringify(defs, null, 2)}\n`,
    'manifest.json': `${JSON.stringify({ generator: 'admin-kit@0.1.0', contractHash: digest(input) }, null, 2)}\n`,
  };
}
...
export async function syncYapi(root) {
  ...
  await writeJson(join(root, '.admin-kit/incoming/yapi-diff.json'), {
